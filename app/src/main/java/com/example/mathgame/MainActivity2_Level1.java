...
public class MainActivity2_Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Level 1 - Addition", Toast.LENGTH_SHORT).show();
    ...
    public void randomNum(){
        if (score <= 9) {
            ...
            Intent intent = new Intent(this, MainActivity2_Level2.class);
